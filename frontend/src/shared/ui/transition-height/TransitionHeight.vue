...
/*
 * @see https://github.com/kostyfisik/transition-height-vue3-ts/blob/main/TransitionHeight.vue
 * @see https://height-transition-vue3-web-animation-api.netlify.app/
 */
