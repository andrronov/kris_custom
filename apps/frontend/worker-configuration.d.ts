/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d43a015133a58c8eadd615892cba8f56)
// Runtime types generated with workerd@1.20251008.0 2025-10-28
declare namespace Cloudflare {
  interface Env {
    VITE_SERVER_URL: string;
    VITE_EXTERNAL_ASSETS_URL: string;
    VITE_ENABLE_DEV_TOOLS: string;
    VITE_API_PROD: string;
    VITE_API_DEV: string;
