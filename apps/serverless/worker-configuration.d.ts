/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6d9b18760c7a23c04724fcf3c0e2e2d7)
// Runtime types generated with workerd@1.20260305.0 2025-10-15 nodejs_compat
declare namespace Cloudflare {
  ...
  interface Env {
    KC_KV: KVNamespace;
    KC_KV_AUTH: KVNamespace;
    KC_KV_SESSION: KVNamespace;
    KC_ASSETS: R2Bucket;
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, "RESEND_API_KEY" | "DATABASE_URL">
    > {}
}
